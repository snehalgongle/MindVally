...
import com.snake.mindvally.base.BaseFragment;
...
public class ListFragment extends BaseFragment implements RepoSelectedListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listView.setAdapter(new RepoListAdapter(getContext(),viewModel, this, this));
    ...
    public void onRepoSelected(User user) {
        ...
        detailsViewModel.setSelectedRepo(user);
